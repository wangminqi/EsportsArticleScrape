...
# 正则处理
    ...
    target_1 = re.sub('<div class="dleft fl">[\s\S]*<h1>', '', target_1, count=0, flags=0)
    target_1 = re.sub('</h1>[\s\S]*</script>','',target_1,count=0,
                      flags=0)
    target_1 = re.sub('<div class="likeart">','',target_1)
        ...
        if len(i) >= 1:
            ...
            if i[0] == '<':
                if 'src="' in i:
                    ...
                    path ='/home/yanziao/文档/工作/info/image/lol/lol德玛西亚/'
